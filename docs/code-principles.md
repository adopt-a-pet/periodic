### Our coding principles everything from falling apart part. This document will define conventions to follow, as well as the higher-level principles that led to those conventions.
