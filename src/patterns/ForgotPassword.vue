...
<div class="login-popup forgot-popup">
    <h1 data-login="e-modal-form-heading" class="e-modal__form--heading forgot-heading__desktop">Forgot Password?</h1>
    <div class="container">
        <h1 data-login="e-modal-form-heading" class="e-modal__form--heading forgot-heading__mobile">Forgot Password?</h1>
        <div class="forgot-password__left">
            <div data-login="login-popup-forgot-pwd" class="login-popup__forgot-pwd">
                ...
                <form @submit.prevent="submit">
                    ...
                    <!-- <div data-login="signup-error-msg" class="signup__error-msg">
                        <span v-if="emailInvalid" class="form__error-msg--bottom p-space-t--tiny" data-password-msg="error-msg-bottom">Please make sure you have the correct email address</span>
                    </div> -->
        ...
        <div class="forgot-password__right">
            <h3 data-h3="heading-museo-xcompact" class="h3__heading">Can't log in with your email address?</h3>
            ...
            <a href="mailto:info@adoptapet.com" class="link-blue">info@adoptapet.com.</a></p>
        </div>
    </div>
</div>
</template>
...
export default {
  ...
  components: {
    // 'email': require('../../../email-field-login/index.vue')
  },
}
</script>
